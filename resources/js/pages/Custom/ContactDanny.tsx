...
const ANDY_PHOTO = "/business/firma/katterine-llanco.png";
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-8">
                <div className="glass-light rounded-xl p-4 inline-block mb-3 border-none shadow-md">
                  <div className="flex items-center gap-3">
                    <h2 className="text-4xl font-extrabold tracking-tight text-black">Katterine Llanco</h2>
                    <span className="inline-block w-3 h-3 rounded-full" style={{ background: ACCENT }} />
                  </div>
                  <p className="text-base text-neutral-600 font-medium">Gerente · Marketing</p>
                </div>

                <div className="flex flex-wrap items-center gap-3">
                  <PillPrimary href={CONTACT.whatsapp} aria="WhatsApp con Katterine">
