...
export const AcademyTemplate: React.FC<TemplateProps> = ({ config, customizations, seo, account }) => {
  ...
  return (
    <>
      ...
      <Head title={seo?.title || businessName}>
        ...
        <meta name="keywords" content={seo?.keywords || `${businessName}, academia, cursos, TRIBIO`} />
